...
Squaring may seem unimportant, but it is used in the exponential, and called at least once for
every bit in the exponent.  BigInt.js only implements a square-modulo operation, so it is omitted
from the first general comparison chart.

<p>
  <div id="square_chart">
    <p>
      <span class="link">
	Compute and show a chart comparing the running time of squaring in jsbn and Long.
      </span>
